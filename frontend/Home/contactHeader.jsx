      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col sm:flex-row items-center justify-between py-2 gap-2">
          ...
          <div className="flex flex-wrap items-center gap-x-6 gap-y-2 text-sm">
            ...
            <a href="mailto:adilameeradi@gmail.com" className="flex items-center gap-2 hover:text-teal-100 transition-colors">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
              ...
              <span className="font-medium">adilameeradi@gmail.com</span>
            </a>
          </div>

          {/* Right: Social Icons */}
          <div className="flex items-center gap-3">
            <a href="https://www.facebook.com/adilameer" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="hover:text-teal-100 transition-colors">
            ...
            <a href="mailto:adilameeradi@gmail.com" aria-label="Email" className="hover:text-teal-100 transition-colors">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
                <path d="M1.5 6.75A2.25 2.25 0 0 1 3.75 4.5h16.5A2.25 2.25 0 0 1 22.5 6.75v10.5A2.25 2.25 0 0 1 20.25 19.5H3.75A2.25 2.25 0 0 1 1.5 17.25V6.75zm2.488.27 6.86 4.116a2.25 2.25 0 0 0 2.304 0l6.86-4.116a.75.75 0 0 0-.76-1.29L12 9.75 4.747 5.73a.75.75 0 1 0-.759 1.29z" />
              </svg>
            </a>
            <a href="https://www.linkedin.com/in/adilameer" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="hover:text-teal-100 transition-colors">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
